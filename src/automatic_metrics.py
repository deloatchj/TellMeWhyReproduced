...
def single_reference_bleurt(df, temp_dir):
    ...
    for choice in selected_choices:
        ...
        bleurt_command = f"python -m bleurt.score_files -candidate_file={temp_dir}/candidates -reference_file={temp_dir}/references-{choice} -bleurt_checkpoint=bleurt -scores_file={temp_dir}/scores-{choice}"
